/**
 * Program to illustrate ArrayList<E> data structure.
 */
 ...
 */
public class CSArrayList<E> implements Iterable<E> {
...
public static int timesDoubled = 1;
   ...
   public void printAll(){
    ...
    /**
     *  Do not lecture. This is a class assignment.
     * @param startIndex
     * @param endIndex
     * @return 
     */    
    ...
    /**
     * Add Private class ArrayIterator to CSArrayList class.
     * @return 
     */
    //@Override
    ...
    /**
     * Private class to implement a generic Iterator for an array.
     * All it requires is a variable for size and to override the
