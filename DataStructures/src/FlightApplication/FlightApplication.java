...
public class FlightApplication {
    ...
    public static void main(String[] args) {
       System.out.println("\n\nCommercial Flight ArrayList");
        ArrayList<CommercialFlight> commList = new ArrayList<>();
        ArrayList<MilitaryFlight> milList = new ArrayList<>();
        ArrayList crew = new ArrayList<String>();
        crew.add("Unger");
        crew.add("Dunne");
        
        CommercialFlight comm1 = new CommercialFlight(65, "EMC2", "CHA", "DTX", crew, 290, 34, 
                34.0, 125.0, "Boeing7 37-400", 2750, 25);
        commList.add(comm1);
...
//        System.out.println("Military: " + pizza.toString());
  ...
  //      System.out.println("Military: " + pizza2.toString());
       ...
       // Collections.sort(commList,fuelComparator);        
        ...
        ArrayList<HelicopterFlight> heliList = new ArrayList<>();
