 ...
 *
 * source:
 * www.newthinktank.com/2013/03/java-hash-table
 *
 * If we think of a Hash Table as an array then a hash function is used to
 * generate a unique key for every item in the array. The position the item goes
 * in is known as the slot. Hashing doesn't work very well in situations in
 * which duplicate data is stored. Also, it isn't good for searching for
 * anything except a specific key. However a Hash Table is a data structure that
...
public class HashFunction {
   ...
   // int hashFactor = 30;      //first run of part 2
    ...
    public static void main(String[] args) {
        ...
        //Second part of lecture, comment out the following line
    ...
    //Second part of lecture
    /**
     * Now lets say we have to hold values between 0 & 998 but we never plan to
     * have more than 30 values in all. It wouldn't make sense to have a 1000
     * item array, so what can we do?
     *
     * One way to fit these numbers into a 30 item array is to use the mod
     * function. All you do is take the modulus of the value versus the array
     * size.
     *
     * The goal is to make the array big enough to avoid collisions, but not so
     * big that we waste memory
     */
